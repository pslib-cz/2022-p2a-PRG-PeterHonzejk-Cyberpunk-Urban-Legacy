        ...
        static void Main(string[] args)
        {
            ...
            if (playerChoice.ToLower() == "yes")
            {
                ...
                if (firstHelper.ToLower() == "mia")
                {
                    ...
                    Console.WriteLine("You still have some time before the hesit. Where would you like to go next, Arasaka Tower or the Night Market? (tower/night market)");
                    ...
                    else if (locationChoice.ToLower() == "night market")
                    {
                        ...
                        {
                            Console.WriteLine("The enigmatic figure reveals themselves as Vex, a ruthless serial killer.");
